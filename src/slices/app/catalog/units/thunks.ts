...
export const startSavingUnit = (data: any): ThunkAction<void, RootState, unknown, Action<string>> => {
...
export const startUpdateUnit = (data: any, id: number): ThunkAction<void, RootState, unknown, Action<string>> => {
    return withLoadingOverlay ( async ( dispatch: ThunkDispatch<RootState, unknown, Action<string>> ) => {
        try {
...
export const startDeleteUnit = (id: number): ThunkAction<void, RootState, unknown, Action<string>> => {
    return withLoadingOverlay ( async ( dispatch: ThunkDispatch<RootState, unknown, Action<string>> ) => {
        try {
